...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-full lg:w-64 shrink-0">
      <div className="rounded-xl p-4 sticky top-24 border border-slate-200 bg-white" style={{ boxShadow: 'none' }}>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-lg text-xs font-bold transition-all border ${
                  isActive
                    ? 'text-blue-600 bg-sky-50 border-blue-200'
                    : 'text-slate-600 bg-transparent border-transparent hover:bg-slate-100 hover:text-slate-800'
                }`}
              >
